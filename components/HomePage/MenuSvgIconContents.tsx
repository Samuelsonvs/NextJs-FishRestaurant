  ...
  return (
    <div className="flex flex-col items-center mt-10 sm:mt-0 leading-8">
      ...
      <Link href={href} passHref>
        <a className="button-active-effect mt-5 flex justify-evenly p-3 w-44 border-2 border-yellow-500 text-yellow-500 rounded-full transition duration-150 ease-in-out hover:bg-yellow-500 hover:text-gray-100 fill-yellow hover:fill-gray-1">
          {aText}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="w-6 h-6 stroke-2 fill"
            viewBox="0 0 20 20"
          >
            <path
              fillRule="evenodd"
